...
function updateMailLinks() {
  ...
  setPhoneLink(phoneWorkLink, String(contactForm.elements.namedItem("phoneWork")?.value || "").trim());
  setPhoneLink(phoneHomeLink, String(contactForm.elements.namedItem("phoneHome")?.value || "").trim());
  setPhoneLink(phoneMobileLink, String(contactForm.elements.namedItem("phoneMobile")?.value || "").trim());
}
